    ...
    <div className="relative w-full flex flex-col">
      ...
      <div className="absolute inset-0 flex items-center">
        <img
          ...
          className="sm:w-48 w-28 sm:h-48 h-28 rounded-full object-cover shadow-xl border-2 shadow-black"
        />

        <div className="ml-5 ">
          <p className="sm:text-3xl text-xl text-white font-bold">{artistId ? artist?.name : songData?.title}</p>
          {!artistId && (
